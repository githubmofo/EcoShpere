// lib/mock-data.ts
// Front-end seed data for demo/hackathon purposes (Gamification + Reports).
// This lets the Gamification and Reports pages run fully client-side without the
// backend. Swap these for `lib/api-client` calls to wire the Express/Prisma API.
