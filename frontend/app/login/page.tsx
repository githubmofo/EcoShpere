...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center relative min-h-screen overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-emerald-500/20 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
      <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-teal-500/10 rounded-full blur-[150px] mix-blend-screen" style={{ animation: "pulse 4s infinite reverse" }} />
      ...
      <Card className="w-full max-w-md p-8 glass-card border-white/10 relative z-10 mx-4">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black tracking-tight text-white mb-2">EcoSphere</h1>
          <p className="text-sm font-medium text-emerald-400/80 uppercase tracking-widest">Sustain OS Console</p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/10 text-center flex flex-col gap-2">
          ...
          <Link href="/register" className="text-emerald-400 hover:text-emerald-300 text-xs font-bold uppercase tracking-widest transition-colors">
            Register Here
          </Link>
        </div>
      </Card>
